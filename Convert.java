...
class Convert{
    ...
    public static void main(){
        ...
        if(ch==2) System.out.println(ob.dec2Oct(n));
        if(ch==3) System.out.println(ob.dec2Hex(n));
        if(ch==4) System.out.println(ob.bin2Dec(n));
        if(ch==5) System.out.println(ob.dec2Oct(ob.bin2Dec(n)));
        if(ch==6) System.out.println(ob.dec2Hex(ob.bin2Dec(n)));
        if(ch==7) System.out.println(ob.oct2Dec(n));
        if(ch==8) System.out.println(ob.dec2Bin(ob.oct2Dec(n)));
        if(ch==9) System.out.println(ob.dec2Hex(ob.oct2Dec(n)));
        if(ch==10) System.out.println(ob.hex2Dec(s));
        if(ch==11) System.out.println(ob.dec2Bin(ob.hex2Dec(s)));
        if(ch==12) System.out.println(ob.dec2Oct(ob.hex2Dec(s)));
    }
}